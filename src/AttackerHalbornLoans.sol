...
contract AttackerHalbornLoans is Initializable, UUPSUpgradeable, MulticallUpgradeable {
    ...
    function burnTokens(address addr, uint amount) external {
        token.burnToken(addr, amount);
    }
